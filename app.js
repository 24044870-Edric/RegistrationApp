...
const db = mysql.createConnection({
    host: 'ekoajd.h.filess.io',
    port: 3307,
    user: 'C237database_climaterod',
    password: 'f2943d7f5db5822968c853cb86706614a8124ae7',
    database: 'C237database_climaterod'
});
...
const validateRegistration=(req,res,next)=> {
    ...
    next(); //if all the validations pass, the next function is called, allowing the request to proceed to the next middleware function or route handler
};
